...
folder_path ="C:/Users/Steve.HAHAHA/Desktop/Dissertation/Overall datasets/" # where the free search, short and medium videos csvs are saved
dataframes = []
...
for filename in os.listdir(folder_path):
    if filename.endswith(".csv"):
        ...
        df['Source'] = filename
        dataframes.append(df) # append the 3 together to get full dataset of video data
...
# Duplicate on the IDs (as there have been changes to the likes between searches and therefore the same videos don't come up as duplicates)
